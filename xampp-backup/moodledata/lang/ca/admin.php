...
/**
 * Strings for component 'admin', language 'ca', version '5.1'.
 *
 * @package     admin
 * @category    string
...
$string['composerdeveloperdependenciesinstalled'] = 'Les dependències del Composer Developer estan instal·lades. Assegureu-vos que l\'ordre «composer install --no-dev --classmap-authoritative» s\'ha executat al directori arrel del Moodle.';
$string['composernotfound'] = 'No s\'han trobat dependències del Composer. Assegureu-vos que l\'ordre «composer install --no-dev --classmap-authoritative» s\'ha executat al directori arrel del Moodle. Si no utilitzeu el Composer, assegureu-vos que el directori del proveïdor existeixi i que contingui els fitxers necessaris.';
$string['composernotoptimised'] = 'El Moodle s\'executarà en mode de producció mentre el carregador automàtic del Composer no estigui optimitzat. Podeu executar «composer install --no-dev --classmap-authoritative» per optimitzar el carregador automàtic.';
$string['composeroptimisedindevmode'] = 'El carregador automàtic del Composer s\'està executant actualment de manera optimitzada mentre el Moodle està en mode de desenvolupador. Això pot causar problemes en alguns casos. És possible que vulgueu executar «composer install» sense arguments addicionals.';
...
$string['configyuicomboloading'] = 'Aquesta opció habilita l\'optimització de la càrrega de fitxers combinada per a les biblioteques YUI. S\'hauria d\'habilitar per motius de rendiment.';
...
$string['courserequestnotifyemail'] = '<p>L\'usuari {$a->user} ha sol·licitat un curs nou.</p>
<p>Podeu revisar la sol·licitud a <a href="{$a->link}">Cursos pendents d\'aprovació</a>.</p>

<p>Detalls de la sol·licitud:</p>
<ul>
<li>Nom complet del curs: {$a->fullname}</li>
<li>Nom curt del curs: {$a->shortname}</li>
<li>Categoria: {$a->category}</li>
<li>Motiu de la sol·licitud del curs: {$a->reason}</li>
</ul>';
...
$string['deletedplugintypesdetected'] = 'S\'ha detectat un connector esborrat, «{$a}». S\'hauria d\'haver migrat/desinstal·lat durant el període de desactivació. Ara és un tipus de connector no compatible i la instal·lació/actualització no pot continuar fins que no es desinstal·li aquest connector.';
...
$string['navfilter'] = 'Filtra el menú personalitzat';
$string['navfilter_desc'] = 'Processa el menú personalitzat a través dels filtres del Moodle que estan configurats per aplicar-se a <strong>Contingut i Encapçalaments</strong>. Útil per habilitar elements de menú dinàmics personalitzats.';
